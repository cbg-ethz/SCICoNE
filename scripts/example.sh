...
# Full tree
../build/scicone-inference --d_matrix_file=5nodes_10regions_10000reads_test_d_mat_segmented_counts.txt --region_sizes_file=test_segmented_region_sizes.txt --n_regions=8 --n_cells=200 --ploidy=2 --verbosity=1 --copy_number_limit=2 --n_iters=4000 --seed=42 --postfix=test
