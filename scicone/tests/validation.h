...
void test_reproducibility()
{
    ...
    // move probabilities
    vector<float> move_probs = {0.0f,1.0f,0.0f,1.0f, 0.0f, 1.0f, 0.0f, 1.0f, 0.0f, 1.0f, 0.01f, 0.0f, 0.00f, 1.0f, 0.01f};
    ...
    // move probabilities
    vector<float> move_probs_max = {0.0f,1.0f,0.0f,1.0f, 0.0f, 1.0f, 0.0f, 1.0f, 0.0f, 1.0f, 0.01f, 0.1f, 0.01f, 1.0f, 0.01f};
    //--------------pr--w-pr--sw--w-sw---ar---w-ar---id---w-id---cs---w-cs--geno---es----ca-----od----dl---
...
void test_genotype_preserving_move_scores()
{
    ...
    assert(abs(score_map[std::make_pair(3,1)] - (-2.303)) <= epsilon);
    assert(abs(score_map[std::make_pair(3,4)] - (-12.303)) <= epsilon);
    assert(abs(score_map[std::make_pair(3,5)] - (-4.606)) <= epsilon);
    assert(abs(score_map[std::make_pair(4,1)] - (-2.302)) <= epsilon);
    ...
    assert(abs(score_map[std::make_pair(5,4)] - (-14.605)) <= epsilon);
