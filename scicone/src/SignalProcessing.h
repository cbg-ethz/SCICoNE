...
public:
    ...
    vector<double> breakpoint_detection(vector<vector<double>> &mat, int window_size, int k_star, vector<int> &known_breakpoints, bool smoothed=false, bool compute_lr=true, bool lr_only=false);
    vector<double> breakpoint_detection(vector<vector<double>> &mat, int window_size, int k_star, vector<int> &known_breakpoints, vector<vector<double>> &lr_vec, bool smoothed=false, bool compute_lr=true, bool lr_only=false);
};
